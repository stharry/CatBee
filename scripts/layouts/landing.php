...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="all"
          href="<?= $GLOBALS[ "rootPath" ] ?>/res/css/jquery.fancybox.css?reload">
    ...
    <script src="<?= $GLOBALS[ "rootPath" ] ?>/res/js/min/TribZi.min.js?reload" type="text/javascript"></script>
