cbf = {
    ...
    byNameList:function(str){
      return document.getElementsByName(str);
    },

    byName:function(str){
        var result = cbf.byNameList(str);
    ...
    getDiv:function (str) {
        ...
        return cbf.valOrDefault(cbf.byId(str),
            cbf.valOrDefault(cbf.byName(str),
                cbf.byClass(str)));
    },
    ...
    setupFrame:function (params) {
        ...
        if (typeof esyXDM == 'undefined') {
            ...
            var jsSrc = cbf.getCatBeeUrl() + "public/res/js/min/easyXDM.min.js?v=1";
