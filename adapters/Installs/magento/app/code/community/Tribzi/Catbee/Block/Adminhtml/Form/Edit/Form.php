...
class Tribzi_Catbee_Block_Adminhtml_Form_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
  ...
  protected function _prepareForm()
  {
    ...
    $fieldset->addField('adpterId', 'text', array(
      'name' => 'Adpter Id',
      'label' => $helper->__('Tribzi adpter id'),
    ));
    $fieldset->addField('campaign', 'select', array(
      'name' => 'campaign',
    ...
    $form->setValues(array('storeId' => $helper->getStoreConfig('Store_Id'), 'adpterId' => $helper->getStoreConfig('Adpter_Id')));
